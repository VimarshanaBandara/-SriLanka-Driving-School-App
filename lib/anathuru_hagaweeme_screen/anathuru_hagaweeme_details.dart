...
class Anathuru_hagaweeme_details extends StatelessWidget {
  final String imagePath;
  final String title;
  final String details;
  final int index;
  Anathuru_hagaweeme_details(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 1.0,
        centerTitle: true,
        title: Text('අනතුරු හැගවීමේ සංඥා',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 18.0),),
        backgroundColor: Colors.white,
        leading: IconButton(
          icon: Icon(Icons.arrow_back_ios_outlined,color: Colors.blueGrey,),
          onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>AnathuruHagaweema()));},
        ),
      ),
      body: Container(
        child: Column(
